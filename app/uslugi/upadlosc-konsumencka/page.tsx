...
export default function UpadloscKonsumenckaPage() {
  const services = [
    {
      title: 'Przygotowanie wniosku',
      description:
        'Przygotowanie wniosku o ogłoszenie upadłości osób fizycznych'
    },
    {
      title: 'Przeprowadzenie postępowania',
      description:
        'Przeprowadzenie postępowania o ogłoszenie upadłości konsumenckiej'
    },
    {
      title: 'Reprezentacja dłużnika',
      description: 'Reprezentacja dłużnika w toku postępowania przed syndykiem'
    },
    {
  ...
  return (
    <main className="min-h-screen">
      ...
      <PageHero
        ...
        subtitle="Profesjonalna pomoc w postępowaniu upadłościowym dla osób fizycznych"
      />
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="flex flex-col items-center">
            ...
            <p className="text-xl md:text-xl lg:text-2xl text-dark leading-relaxed text-center font-light">
              Nasza kancelaria pomaga osobom indywidualnym przejść przez
              postępowanie upadłościowe &ldquo;konsumenckie&rdquo;. Wspieramy
              naszych klientów w przygotowaniu wniosków o ogłoszenie upadłości,
              a także reprezentujemy przed sądem, w kontakcie z syndykiem czy
              wierzycielami.
            </p>
