...
export default function RestrukturyzacjaFirmPage() {
  const services = [
    {
      title: 'Analiza sytuacji',
      description: 'Analiza sytuacji finansowej i prawnej przedsiębiorstwa'
    },
    {
      title: 'Dobór postępowania',
      description:
        'Dobór odpowiedniego rodzaju postępowania restrukturyzacyjnego (postępowanie o zatwierdzenie układu, postępowanie układowe, przyspieszone postępowanie układowe, postępowanie sanacyjne)'
    },
    {
      title: 'Propozycje układowe',
      description: 'Opracowanie propozycji układowych z wierzycielami'
    },
    {
      title: 'Reprezentacja dłużnika',
      description: 'Reprezentacja dłużnika w negocjacjach oraz przed sądem'
    },
    {
      title: 'Nadzór nad realizacją',
      description: 'Nadzór nad realizacją przyjętych rozwiązań'
    },
    {
      title: 'Reprezentacja wierzycieli',
      description:
        'Reprezentacja wierzycieli w postępowaniu restrukturyzacyjnym'
    }
  ];
  ...
  return (
    <main className="min-h-screen">
      ...
      <PageHero
        ...
        subtitle="Kompleksowe wsparcie w procesie restrukturyzacji przedsiębiorstw"
      />
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="flex flex-col items-center">
            ...
            <p className="text-xl md:text-xl lg:text-2xl text-dark leading-relaxed text-center font-light">
              Zapewniamy wsparcie na każdym etapie procesu restrukturyzacji
              poczynając od analizy sytuacji finansowej i prawnej
              przedsiębiorstwa, poprzez dobór odpowiedniego rodzaju postępowania
              restrukturyzacyjnego, aż po nadzór nad realizacją przyjętych
              rozwiązań.
            </p>
